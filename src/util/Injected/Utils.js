...
exports.LoadUtils = () => {
    ...
    window.WWebJS.getChat = async (chatId, { getAsModel = true } = {}) => {
        ...
        if (isChannel) {
            ...
            chat = (await window.Store.FindOrCreateChat.findOrCreateLatestChat(chatWid).catch(() => { return {} }))?.chat || window.Store.Chat.get(chatWid) || (await window.Store.Chat.find(chatWid));
        }
